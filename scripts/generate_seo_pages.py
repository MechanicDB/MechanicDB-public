...
def generate_code_page(code, dtc):
    ...
    page_url = f"{DOMAIN}/landing/{code}.html"
    ...
    sys_url = f"{DOMAIN}/landing/{sys_file_map.get(sys_cat, 'powertrain.html')}"
...
<header class="bar">
  <div class="wrap bar-inner">
    <a href="../index.html" class="wordmark"><span class="mil" aria-hidden="true"></span>MechanicDB</a>
    <nav style="font-family: var(--mono); font-size: 0.82rem; display: flex; gap: 20px;">
      <a href="../index.html#interactive">Decoder</a>
      <a href="../index.html#licensing">Dataset License ($49)</a>
...
<div class="wrap">
  <div class="breadcrumb">
    <a href="../index.html">Home</a> / <a href="../index.html#interactive">Diagnostic Decoder</a> / <a href="{sys_file_map.get(sys_cat, 'powertrain.html')}">{sys_cat} System</a> / <span>Code {code_esc}</span>
  </div>
...
def generate_category_hub(sys_cat, filename, title, codes_list):
    page_url = f"{DOMAIN}/landing/{filename}"
    ...
    for c in codes_list:
        ...
        rows_html += f"""
        <tr>
          <td><a href="{code}.html" style="font-family: var(--mono); font-weight: 700; font-size: 1.1rem; color: var(--amber);">{code}</a></td>
        ...
        "itemListElement": [
            {
                ...
                "url": f"{DOMAIN}/landing/{c['dtc_code']}.html"
            }
...
<div class="wrap" style="padding-top: 30px; padding-bottom: 60px;">
  <div class="breadcrumb"><a href="../index.html">Home</a> / <span>{html.escape(sys_cat)} System Directory</span></div>
...
def generate_sitemap(codes_list):
    ...
    for hub in ["powertrain.html", "chassis.html", "body.html", "network.html"]:
        urls.append(f"""  <url>
    ...
    for c in codes_list:
        urls.append(f"""  <url>
    <loc>{DOMAIN}/landing/{c['dtc_code']}.html</loc>
    <lastmod>{today}</lastmod>
    <changefreq>monthly</changefreq>
