...
| **Heavy Duty (J1939)** | Standalone: SAE J1939 SPN+FMI fault pairs from published OEM fault tables (Eaton, WABCO, Bendix, Deutz, John Deere, Navistar, Cummins, Caterpillar, PSI, Perkins, Yanmar) with ranked fixes and part mappings · CSV + Parquet + SQLite | $149 — **release pending** ([100-fault free sample](samples/heavyduty/) available now; see [DATA_DICTIONARY.md](DATA_DICTIONARY.md), section 6) |
